            ...
            <div className='card'>
                    ...
                    <form>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="email" onChange={inputHandler} name='email' value={profileData.email} className="form-control" id="email" />
                            ...
                            <div className="mb-3">
                                ...
                                <input type="file" name='p_image' onChange={handleFileChange} className="form-control" id="profileImg" accept="image/*" />
                                <p>
